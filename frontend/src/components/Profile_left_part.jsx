        ...
        <>
            ...
            <div class="bg-white  dark:bg-[#1A1D20] md:rounded-2xl md:shadow-[2px_4px_12px_0px_rgba(0,0,0,0.10)] h- md:h-[82.5vh]  ">
                <div className=" px-[4.2vw]  md:pl-[1.2vw] md:pr-[1.3vw]   md:pt-[2.5vh] relative">
                    ...
                    <div className=' absolute bottom-[-9vh] left-[20vw]  lg:bottom-[-8.5vh]  lg:left-[6vw] md:bottom-[-8vh] md:left-[5.5vw] '>
                        <div className='flex items-end'>
                            ...
                            <span className='text-[#012436] dark:text-[#F2F3FF] md:text-[16px] lg:text-[20px] font-poppins font-semibold mr-[5px]' >Campus</span> <span className=' text-[#394FF1] dark:text-[#FFFFFF]  md:text-[16px] lg:text-[22px] font-poppins font-semibold'>Mart</span>
                        </div>
                    </div>
                </div>
            </div>
