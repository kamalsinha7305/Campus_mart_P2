  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      if (user) {
        ...
        // 3. Send the token AND profile data to your backend
          ...
          <div className='w-3/4  mx-auto'  >
            ...
            <button className='text-black text-[18px] font-bold font-Poppins my-[20px] rounded-[12px] border border-[#dbdbdb] w-[412px] flex justify-center items-center h-[50px] '> <img src={Image1} alt="" className='h-[40px] w-[40px] mx-[10px]' />Continue with Google </button>
              ...
              <div className='mt-[3vh]'>
                ...
                <div className="text-[#1e1e1e] dark:text-[#D6D6D6] text-[13.5px]  lg:text-[16px] font-normal font-['Poppins'] lg:mb-[0.3vh]">First Name</div>
                <input className='form-control w-[77vw] h-[5.2vh] rounded-[3px] lg:w-[24.5vw] lg:h-[5.8vh] lg:rounded-[5px]  font-normal lg:font-semibold border border-[#bbc2c9] mb-[1.2vh] pl-[4vw] lg:pl-[1.3vw] text-[13px] dark:text-white dark:bg-[#1a1d20]'
                  type='text'
                  name='text'
                  autoFocus
              ...
              <div>
                <label htmlFor="text"></label>
                <div className="text-[#1e1e1e]  dark:text-[#D6D6D6] text-[13.5px] lg:text-[16px] font-normal font-['Poppins'] lg:mb-[0.3vh] ">Last Name</div>
              ...
              <div className=''>
                ...
                <div className="text-[#1e1e1e] dark:text-[#D6D6D6] text-[13.5px] lg:text-[16px] font-normal font-['Poppins'] mb-[0.3vh] ">Email</div>
                <input className='form-control  w-[77vw] h-[5.2vh] rounded-[3px]  lg:w-[24.5vw] lg:h-[5.8vh] lg:rounded-[5px] font-normal lg:font-semibold  border border-[#bbc2c9]  mb-[1.2vh] pl-[4vw] lg:pl-[1.3vw] text-[12.5px] dark:text-white dark:bg-[#1a1d20]'
                  type='email'
                  name='email'
              ...
              <div className='relative'>
                ...
                <div className="text-[#1e1e1e]  dark:text-[#D6D6D6] text-[13.5px] lg:text-[16px] font-normal font-['Poppins'] lg:mb-[0.3vh] ">Password</div>
                <input className='form-control  w-[77vw] h-[5.2vh] rounded-[3px]  lg:w-[24.5vw] lg:h-[5.8vh] lg:rounded-[5px] font-normal lg:font-semibold border border-[#bbc2c9]  mb-[1.2vh] pl-[4vw] lg:pl-[1.3vw] text-[12.5px] dark:text-white dark:bg-[#1a1d20]'
              ...
              <div><span className='text-[#848484] text-[13px]  lg:text-[15px] font-normal font-poppins'>Already have a account? </span><Link to={"/"}><span className=' text-[#292929] dark:text-neutral-300 text-[13px] lg:text-[15.5px] font-normal font-poppins'> Login {'>'} </span></Link></div>

            </form>
          </div>
        </div>

       <div className='flex flex-col justify-center items-center w-full  absolute bottom-[-0.9vh] lg:bottom-[2.9vh] '>
