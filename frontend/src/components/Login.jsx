 ...
 const [email, setEmail] = useState("");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      window.location.href = "/profile"; // This works, but using navigate() is preferred
  ...
  return (
    <div className='flex overflow-hidden'>
      ...
      <div className=' relative h-screen w-[100%] lg:w-[38%] bg-white shadow dark:bg-[#131313] '>
        ...
        <div className='flex  items-center justify-center mt-[6vh]'> <svg className='mb-[0.5vh]' width="22" height="22" viewBox="0 0 27 26" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <span className='text-[#012436] dark:text-[#FFFFFF] text-[18px] lg:text-[1.5rem] font-poppins font-semibold ml-[0.3vw] ' >Campus Mart</span>
        </div>
        <div className=''>

          <h1 className=' flex items-center justify-center mt-[3vh] lg:mt-[4vh]'> <span className='  font-robotoflex text-black text-[18px] dark:text-[#F1F1F1] font-semibold lg:text-[1.65rem] mr-[6px]'>Welcome to </span> <span className='font-robotoflex font-semibold text-[#005df5] lg:text-[1.65rem] text-[18px]'> Campus Mart</span></h1>

          <div class="flex items-center justify-center text-[#828f9b] dark:text-[#D6D6D6] text-[13px] lg:text-[1.025rem] font-normal font-['Poppins'] mb-[3vh]">Enter your details to access Campus Mart.</div>
          <div className='w-3/4  mx-auto'  >
            <form onSubmit={handleSubmit} className='flex flex-col items-center justify-center'>

              <div className='mt-[3vh]'>
                <label htmlFor="email"></label>
                <div className="text-[#1e1e1e]   dark:text-[#D6D6D6] text-[13.5px] lg:text-[16px] font-normal font-['Poppins'] lg:mb-[0.5vh]">Email</div>
                <input className='w-[77vw] h-[5.2vh] rounded-[3px] lg:w-[24.5vw] lg:h-[5.8vh] lg:rounded-[5px] font-normal lg:font-semibold border border-[#bbc2c9] pl-[4vw]  dark:text-white dark:bg-[#1a1d20] lg:pl-[1.3vw] text-[12.5px] mb-[1.4vh]'
                  type='email'
                  name='form-control'
                  value={email}
              ...
              <div className='relative'>
                <div className="text-[#1e1e1e] dark:text-[#D6D6D6] text-[13.5px] lg:text-[16px] font-normal font-['Poppins'] mb-[0.5vh] ">Password</div>
                <label htmlFor="passsword"></label>

                <input className='w-[77vw] h-[5vh] lg:w-[24.5vw] lg:h-[5.8vh] rounded-[3px] lg:rounded-[5px] font-normal lg:font-semibold border border-[#bbc2c9] pl-[4vw] lg:pl-[1.3vw] text-[12.5px] mb-[1.2vh] dark:text-white dark:bg-[#1a1d20] '
                ...
                > </input>
                  <button type='button' className="absolute top-[4.5vh] md:top-[4.7vh] lg:top-[5.5vh] right-3 flex items-center" onClick={() => setShowPassword(!showPassword)}>{showPassword ? <EyeOff size={20} /> : <Eye size={20} />}</button>
                <div className='flex justify-between items-center mt-[1vh]'>
                  <div className=" text-[#848484] text-[12px] lg:text-sm lg:font-normal font-['Poppins']"> <input className="mr-[0.3vw]  mt-" type="checkbox" name="" id="" /> Remember me </div>
                  <div className="text-[#2d3339]  dark:text-[#BBC2C9] text-[12px] lg:text-sm font-normal font-['Poppins']">Forgot Password</div>
                </div>
              ...
              <div class=" justify-center items-center  inline-flex gap-2">
                ...
                <div class="text-[#64707d] dark:text-[#D6D6D6] text-[13px] lg:text-[14px] font-normal font-['Poppins'] ">or continue with</div>
                <div class="w-[7vw] h-[0px] border border-[#d6d6d6]"></div>
              </div>

              <SignInwithGoogle />

              <div><span className='text-[#848484] text-[13px] lg:text-[15px] font-normal font-poppins'>Don't have a account ? </span><Link to={"/signup"}><span className=' text-[#292929] dark:text-neutral-300 text-[13px] lg:text-[15.5px] font-normal font-poppins'> Create account {'>'} </span></Link></div>
        ...
        <div className='flex flex-col justify-center items-center w-full  absolute bottom-[-0.9vh] lg:bottom-[-0.5vh] '>
          <div class="text-center"><span class="text-zinc-500  text-[11px] lg:text-[12.5px] font-normal font-['Poppins']">By clicking "Create account" I acknowledge that <br />I agree to the </span><span class="text-gray-700  dark:text-[#AAB9C5] text-[11px] lg:text-[13px] font-normal font-['Poppins']  ">Terms of Use</span><span class="text-zinc-500   text-[11px] lg:text-[13px] font-normal font-['Poppins']"> and </span><span class="text-zinc-700  dark:text-[#AAB9C5] text-[11px] lg:text-[13px] font-normal font-['Poppins'] ">Privacy Policy</span><span class="text-zinc-500  text-[11px] lg:text-sm font-normal font-['Poppins']">.</span></div>
