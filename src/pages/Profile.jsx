                ...
                {userDetails ? (
                    ...
                    <div className='md:flex lg:flex'>
                        ...
                        <div className=' h-screen md:w-[65%] lg:w-[75%] overflow-scroll bg-[#FBFBFB]'>
                            ...
                            <div class=" bg-white rounded-[20px] shadow-[0px_4px_10px_0px_rgba(101,101,101,0.10)] mx-[4.5vw] mt-[3.7vh] pt-[4vh] pb-[2vh] relative">

                                <div class="  text-[#2d3339] text-[15px] font-medium lg:text-xl lg:font-semibold font-['Poppins'] ml-[2.6vw] mb-[2vh]">Personal Information</div>
                                <div className='lg:grid grid-cols-2 grid-rows-2 ml-[3.5vw] '>
                                    <div class="">
                                        <div class="  text-[#848484] text-[13px] lg:text-lg font-normal font-['Poppins']">Name</div>
                                        <div class="  text-[#2d3339] text-[14px] lg:text-[18px] lg:font-medium font-['Poppins'] lg:mb-[2.7vh] max-sm:mb-[2vh] ">{userDetails.firstName} {userDetails.lastName} </div>
                                    </div>

                                    <div class=" ">
                                        <div class=" text-[#848484] text-[13px] lg:text-lg font-normal font-['Poppins']">Email</div>
                                    ...
                                    <div className="mb-[2.7vh]">
                                        ...
                                        <div className="  text-[#2d3339] lg:text-[18px] text-[14px] lg:font-medium font-['Poppins']  max-sm:mb-[2vh]">Male</div>
                                    </div>
                                </div>
                            ...
                            <div className=" bg-white rounded-[20px] shadow-[0px_4px_10px_0px_rgba(101,101,101,0.10)] mx-[4.5vw] mt-[3.7vh] pt-[4vh] pb-[4.5vh] relative">
                            ...
                            <div className=" bg-white rounded-[20px] shadow-[0px_4px_10px_0px_rgba(101,101,101,0.10)] mx-[4.5vw] mt-[3.7vh] pt-[4vh] pb-[2vh] relative mb-[2.8vh]">

                                <div className="  text-[#2d3339] text-[14px] lg:text-xl lg:font-semibold font-['Poppins'] ml-[2.6vw] mb-[2vh]">Account Actions</div>
                                <div className='lg:grid lg:grid-cols-2 lg:grid-rows-2 ml-[3.5vw]'>
                                    <div className="">
                                        <div className="  text-[#1e1e1e] lg:text-[18px] text-[14px] font-medium font-['Poppins']">Logout</div>
                                        <div className="  text-[#64707d] lg:text-[17px] text-[13px] font-medium font-['Poppins'] mb-[2.7vh]">Sign out from all devices</div>
                                    </div>
                                    ...
                                    <div className=" ">
                                        <div className=" text-[#1e1e1e] text-[14px] lg:text-[18px]  font-medium font-['Poppins']">Delete Account</div>
                                        <div className=" text-[#64707d] text-[13px] lg:text-[17px] font-medium font-['Poppins']">Permanently delete your account and all data</div>
                                    </div>
