...
function Profile_left_part() {
    ...
    relative flex items-center px-[4vw] py-[1.2vh] md:px-[0.8vw] md:py-[1.2vh] rounded-lg transition-all duration-300 cursor-pointer
    hover:bg-[#E9ECFF] dark:hover:bg-[#131313] hover:scale-105
    ${active
                ...
                <div class="bg-white  dark:bg-[#1A1D20] md:rounded-2xl md:shadow-[2px_4px_12px_0px_rgba(0,0,0,0.10)] h- md:h-[82.5vh]  ">
                    <div className=" px-[4.2vw]  md:pl-[1.2vw] md:pr-[1.3vw]   md:pt-[2.5vh] relative">
                        <Link to='/profile'>
                            <div className=" ">
                                <div class=" relative ">
                                    <div class="bg-[#f6f7ff] dark:bg-[#282A2C] rounded-lg flex items-center p-5 md:p-4  pl-[3.5vw] md:pl-[1.8vw]  md:mx-0 mb-[2vh] md:mb-[2vh] transition-all duration-300 cursor-pointer hover:bg-[#e9ecff] hover:scale-105 ">
                                        <img class=" rounded-full w-[47px] h-[47px] lg:w-[3vw] lg:h-[6.3vh] md:mr-[1vw] mr-[2.5vw]" src={Image1} />
                                        <div className="flex flex-col ">
                                            <div class=" text-black dark:text-white  text-[13px] md:text-[14px] lg:text-[16px] font-normal font-['Poppins']">Kamal Sinha</div>
                                            <div class=" text-[#979797] text-[10px] md:text-[9px] lg:text-[10px] font-normal font-['Poppins']">Kamal.sinha2022@vitstudent.ac.in</div>
                                        </div>
                            ...
                            {menu.map(({ path, label, icon: Icon, badge }) => {
                                ...
                                return (
                                    <Link key={path} to={path} className="block pb-[0.2vh]">
                                        <div
                                            className={`relative flex items-center px-[3vw] py-[1.2vh] md:px-[0.8vw] md:py-[1.2vh] rounded-lg transition-all duration-300 cursor-pointer hover:bg-[#e9ecff] dark:hover:bg-[#131313]  hover:scale-105 ${active
                                                ? "bg-gradient-to-r from-[#394ff1] to-[#4d4ef2] text-white"
                                                : " text-[#292929]  dark:text-white"}`}>
                                            <div
                                                data-svg-wrapper
                        ...
                        <div className=' absolute bottom-[-9vh] left-[20vw]  lg:bottom-[-10vh]  lg:left-[6vw] md:bottom-[-8vh] md:left-[5.5vw] '>
                            <div className='flex items-end'>
                                <div data-svg-wrapper className="mr-[0.5vw] lg:mr-[0.4vw] mb-[1.1vh]">
